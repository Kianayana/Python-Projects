...
class ParentWindow(Frame):
    ...
    def transferFiles(self):
        ...
        #This code does not return any errors (that I can find), but functions in the same way as the priginal for statement. I'm not sure how to get it to use "if fix2 < fl_fix:)
